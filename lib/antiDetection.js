...
class AntiDetection {
    constructor() {
        ...
        // Emojis – defined BEFORE buildMessageTemplates() is called
        this.emojis = ['😊', '😂', '🔥', '💪', '🙌', '✨', '💯', '🎯', '🚀', '⭐', '❤️', '👍', '👋', '🤝', '💙', '💜', '🧡', '💛', '💚', '🖤'];

        // Build human-like message templates (uses this.emojis)
    ...
    // ==============================================
    // SEND MESSAGE WITH STEALTH (ENHANCED)
    // ==============================================
